...
ENTITIES = [
    {
        ...
        "output": "./content/entity-files/classlist.js",
        "strip_prefix": "",
        "strip_suffix":"main"
    },
    {
        ...
        "exclude_suffixes": ["all.html"],
        "output": "./content/entity-files/subclasslist.js",
        "strip_prefix": "",
        "strip_suffix":""
    },
    {
        ...
        "exclude_suffixes": ["all.html","content.html"],
        "output": "./content/entity-files/spelllist.js",
        "strip_prefix": "spell",
        "strip_suffix":""
    },
    {
        ...
        "exclude_suffixes": ["all.html"],
        "output": "./content/entity-files/backgroundlist.js",
    ...
    },
    {
        ...
        "exclude_suffixes": ["all.html"],
        "output": "./content/entity-files/specieslist.js",
        ...
        if entity["name"] == "subclasses":
            ...
            try:
                with open(filepath, "r", encoding="utf-8") as f:
                    ...
                    level_text = " ".join(soup.select_one("#spell-level-label").get_text(strip=True).lower().split())
